...
how to download and install **Connect** in your system. 
...
To install **Connect** from soruce code, use the provided installation script::
...
the `source code repository`_ using ``pip``::
    ...
    pip install -e git+https://github.com/hdknr/jose.git#egg=jose

The above command will install the latest development release of **Connect**.
